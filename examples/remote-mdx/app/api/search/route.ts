import { type AdvancedIndex, createSearchAPI } from 'deck-core/search/server';
import * as fs from 'node:fs/promises';
import { getPages } from '@/app/docs/utils';
import { parseFrontmatter } from '@deck/mdx-remote';
import { structure } from 'deck-core/mdx-plugins';
