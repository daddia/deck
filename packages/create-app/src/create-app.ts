...
function createPackageJson(projectName: string, options: Options): object {
  if (options.template === 'react-router') {
    return {
      ...
      dependencies: {
        ...pick(localVersions, ['@deck/mdx-remote', 'deck-core', 'deck-ui']),
  ...
  if (options.template === 'tanstack-start') {
    return {
      ...
      private: true,
      dependencies: {
        ...pick(localVersions, ['@deck/mdx-remote', 'deck-ui', 'deck-core']),
        ...pick(versionPkg.dependencies, [
  ...
  return {
    ...
    dependencies: {
      ...
      ...pick(localVersions, ['deck-ui', 'deck-core']),
      ...(options.template === '+next+content-collections'
        ? {
            ...
            ...pick(localVersions, ['@deck/content-collections']),
          }
        : null),
      ...(options.template === '+next+fuma-docs-mdx'
        ? pick(localVersions, ['deck-mdx'])
        : null),
    },
    devDependencies: {
      ...pick(versionPkg.dependencies, [
