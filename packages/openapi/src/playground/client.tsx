...
import { DynamicCodeBlock } from 'deck-ui/components/dynamic-codeblock';
...
import {
  ...
  CollapsibleContent,
  CollapsibleTrigger,
} from 'deck-ui/components/ui/collapsible';
...
import { useEffectEvent } from 'deck-core/utils/use-effect-event';
import type { RequestData } from '@/requests/_shared';
import { buttonVariants } from 'deck-ui/components/ui/button';
import { cn } from 'deck-ui/utils/cn';
...
function usePersistentAuthInfo(authorization?: ClientProps['authorization']) {
  const key = authorization
    ? `__deck_auth_${authorization.persistentId}`
    : null;
