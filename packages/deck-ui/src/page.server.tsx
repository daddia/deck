...
import type { LoaderConfig, LoaderOutput, Page } from 'deck-core/source';
import { getPageTreePeers, type PageTree } from 'deck-core/server';
import { Card, Cards } from '@/components/card';

/**
 * @deprecated use https://deck.daddia.com/docs/ui/markdown#further-reading-section instead
 */
