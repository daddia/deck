...
export const openapiPlugin: Plugin = {
  ...
  dependencies: ['deck-openapi', 'rimraf', 'shiki'],
  async transform(ctx) {
    ...
    await Promise.all([
      ...
      transformTailwind(project, {
        addContents: [`./node_modules/deck-openapi/dist/**/*.js`],
      }),
      addScript(),
    ]);
  },
...
You can add the APIPage component to your page.tsx:`,
    },
    {
      type: 'code',
      title: 'page.tsx',
      code: `import defaultMdxComponents from 'deck-ui/mdx';
...
async function transformSource(
  ...
  file.addImportDeclaration({
    ...
    moduleSpecifier: 'deck-openapi/server',
  });
