...
program
  .name('deck')
  .description('CLI to setup deck, init a config ')
...
program
  .command('customise')
  .alias('customize')
  .description('simple way to customise layouts with deck UI')
...
const dirShortcuts: Record<string, string> = {
  ':dev': 'https://deck-dev.vercel.app/registry',
};
...
function getResolverFromDir(
  dir: string = 'https://deck.daddia.com/registry',
): Resolver {
