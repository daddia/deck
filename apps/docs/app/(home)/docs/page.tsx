  ...
  return (
    <main className="container flex flex-col items-center py-16 text-center z-[2]">
      ...
      <p className="text-fd-muted-foreground">
        You can start with deck, or just use the core library.
      </p>
      <div className="mt-4 grid grid-cols-2 gap-4">
        <a
          href="https://github.com/daddia/deck"
      ...
      <div className="mt-16 grid grid-cols-1 gap-4 text-left md:grid-cols-2">
        <Item href="/docs/ui">
          ...
          <h2 className="mb-2 text-lg font-semibold">deck</h2>
        ...
        <Item href="/docs/headless">
          ...
          <h2 className="mb-2 text-lg font-semibold">deck Core</h2>
          <p className="text-sm text-fd-muted-foreground">
            The core library of deck.
          </p>
        </Item>
      </div>
    </main>
