...
export function CreateAppAnimation() {
  const installCmd = 'npm create deck-app';
  const tickTime = 100;
  ...
  if (tick > timeCommandRun)
    lines.push(
      <Fragment key="command_response">
        <span className="font-bold">┌ Create deck App</span>
        <span>│</span>
      ...
      <div className="flex-1">
        {active === 0 ? (
          <WhyPanel>
            ...
            <p>
              deck offers native support for Orama and Algolia Search, it is as
        ...
        {active === 2 ? (
          <WhyPanel>
            ...
            <p>
              deck has a smart Type Table component that renders the properties
              of interface/type automatically, powered by the TypeScript
              Compiler API.
            </p>
            {props.typeTable}
            <p>
        ...
        {active === 3 ? (
          <WhyPanel>
            ...
            <p>
              deck offers many useful components, from File Tree, Tabs, to
              Zoomable Image.
            </p>
        ...
        {active === 5 ? (
          <WhyPanel>
            ...
            <p>
              deck is designed to be flexible, working with any content sources,
              offering powerful utilities.
              <br />
              <br />
