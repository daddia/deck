...
import { TypeTable } from 'deck-ui/components/type-table';
    ...
    <div className="flex flex-col gap-4 border-x border-t px-8 py-16 md:py-24 lg:flex-row md:px-12">
      <div className="shrink-0 flex-1 text-start">
        ...
        <p className="text-fd-muted-foreground mb-6">
          deck makes it easy to build beautiful docs, write content, and
        ...
        <div className="flex flex-row items-center font-mono -mx-4">
          <a
            href="https://github.com/daddia/deck-basehub"
          ...
          <a
            href="https://github.com/daddia/deck-sanity"
            rel="noreferrer noopener"
            target="_blank"
            className={cn(buttonVariants({ variant: 'link' }))}
          >
...
@source '../node_modules/deck-ui/dist/**/*.js';`}
          />
        }
        codeblockInteractive={
          <CodeBlock
            lang="tsx"
            code={`import { File, Folder, Files } from 'deck-ui/components/files';
    ...
    <div className="grid grid-cols-1 border-b border-r md:grid-cols-2 lg:grid-cols-3">
      <div className="relative flex flex-col gap-8 overflow-hidden border-l border-t px-8 py-14">
        ...
        <div className="flex flex-row flex-wrap gap-2 border-t pt-4">
          ...
          <a
            href="https://stackblitz.com/~/github.com/daddia/deck-ui-template"
            rel="noreferrer noopener"
            className={cn(
              buttonVariants({
                variant: 'outline',
  ...
  return (
    <div className="relative z-[2] flex flex-col border-x border-t bg-fd-card/80 px-6 pt-12 max-md:text-center md:px-12 md:pt-16 [.uwu_&]:hidden max-lg:overflow-hidden">
      ...
      <p className="mb-8 text-fd-muted-foreground md:max-w-[80%] md:text-xl">
        deck is a beautiful documentation framework for Developers, flexible and
        performant, with everything from Next.js.
      </p>
  ...
  return (
    <div className="flex flex-col items-center border-x border-t px-4 py-16 text-center">
      ...
      <p className="mb-4 text-fd-muted-foreground">
        deck is 100% powered by passion and open source community.
      </p>
      <div className="mb-8 flex flex-row items-center gap-2">
        ...
        <a
          href="https://github.com/daddia/deck/graphs/contributors"
          rel="noreferrer noopener"
  ...
  return (
    <div className="grid grid-cols-1 border-r md:grid-cols-2">
      <Feature
        ...
        description={
          <>
            ...
            <span>
              deck has native support for Content Collections and deck MDX, and
              compatible with your own CMS.
            </span>
          </>
        }
      ...
      <Feature
        ...
        description="deck CLI creates interactive components for your docs, offering a rich experience to your users."
      >
        <CodeBlock
          code="npx @deck/cli add"
          lang="bash"
          wrapper={{
            title: 'Terminal',
            allowCopy: false,
        ...
        <div className="mt-8 flex flex-col gap-4">
          ...
          >
            <div className="rounded-[inherit] bg-fd-background bg-gradient-to-br from-transparent via-fd-primary/10 p-4 transition-colors hover:bg-fd-muted">
              <LayoutIcon />
              <h3 className="font-semibold">deck UI</h3>
              <p className="text-sm text-fd-muted-foreground">
                Default theme of deck with many useful components.
              </p>
            </div>
          </Link>
          <Link
