...
import { Heading } from 'deck-ui/components/heading';
import { Card } from 'deck-ui/components/card';
import { Callout } from 'deck-ui/components/callout';
import { Accordion, Accordions } from 'deck-ui/components/accordion';
import { RootToggle } from 'deck-ui/components/layout/root-toggle';
import { Tab, Tabs } from 'deck-ui/components/tabs';
import { Step, Steps } from 'deck-ui/components/steps';
import { TypeTable } from 'deck-ui/components/type-table';
import { type ReactNode } from 'react';
import { Wrapper } from './wrapper';
import { GithubInfo } from 'deck-ui/components/github-info';
  ...
  return (
    <Wrapper>
      <Accordions type="single" collapsible>
        <Accordion id="what-is-deck" title="What is deck?">
    ...
    <Wrapper>
      <div className="flex flex-col gap-4">
        <Banner className="z-0" changeLayout={false}>
          Be careful, deck v99 has released
        </Banner>
