---
title: Performance
description: The performance of deck MDX
icon: Rocket
---

## Overview

deck MDX is a bundler plugin, in other words, it has a higher performance bottleneck.
...
Since deck MDX works with your bundler, you can import any files including client components in your MDX files.
This allows a high flexibility and ensures everything is optimized by default.

### Image Optimization

deck MDX resolves images into static imports with [Remark Image](/docs/headless/mdx/remark-image).
...
Although deck MDX can handle nearly 500+ files, it could be slow and inefficient.
