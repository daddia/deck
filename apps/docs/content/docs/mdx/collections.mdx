...
import { defineCollections, getDefaultMDXOptions } from 'deck-mdx/config';
...
By design, this will remove all default settings applied by your global config and deck MDX.
...
```ts
import { frontmatterSchema, metaSchema, defineDocs } from 'deck-mdx/config';
import { z } from 'zod';
