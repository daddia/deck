...
description: Integrate Algolia Search with deck
---
...
- [deck UI Usage](/docs/ui/search#algolia)
...
- **deck UI**: Enable [Tag Filter](/docs/ui/search#tag-filter-1) on Search Dialog.
