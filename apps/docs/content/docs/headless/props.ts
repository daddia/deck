import type * as Breadcrumb from 'deck-core/breadcrumb';
import type * as TOC from 'deck-core/toc';
import type * as Server from 'deck-core/server';
import type * as Sidebar from 'deck-core/sidebar';
import type { ElementType } from 'react';
import type * as MDX from 'deck-core/mdx-plugins';
