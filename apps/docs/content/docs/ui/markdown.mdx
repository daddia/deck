...
deck provides many useful extensions to MDX, a markup language. Here is a brief introduction to the default MDX syntax of deck UI.

> MDX is not the only supported format of deck. In fact, you can use any renderers such as `next-mdx-remote` or CMS.
...
You can see [a list of plugins](/docs/headless/mdx) provided by deck.
