...
export const baseOptions: BaseLayoutProps = {
  githubUrl: 'https://github.com/daddia/deck',
  nav: {
    title: 'My App',
  },
};
...
deck uses **CSS Variables** to share the size of layout components, and fit each layout component into appropriate position.
