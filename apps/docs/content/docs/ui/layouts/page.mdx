...
```tsx title="page.tsx"
import { DocsPage, DocsDescription, DocsTitle, DocsBody } from 'deck-ui/page';
...
```tsx
import { DocsBody } from 'deck-ui/page';
...
```tsx
import { DocsPage } from 'deck-ui/page';
...
[TOC Utility](/docs/headless/utils/get-toc). Content sources like deck MDX offer this out-of-the-box.
...
remote sources like Sanity, deck UI doesn't display the last updated time by
default.
...
```tsx
import { DocsPage } from 'deck-ui/page';
import { getGithubLastEdit } from 'deck-core/server';
...
<Callout type='info' title='Note'>
    ...
    Don't forget to [update the schema type](/docs/mdx/collections#schema) on deck MDX first.
