...
Next.js provides an useful set of utilities, allowing a flexible experience with deck.
deck uses the Next.js Metadata API for SEO.
...
For docs pages, deck has a built-in metadata image generator.
