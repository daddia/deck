...
deck doesn't bundle with other plugins, you have to manually install
those plugins.
...
The code might be vary depending on your content source, here is an example for deck MDX:
