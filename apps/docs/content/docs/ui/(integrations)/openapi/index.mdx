...
/* [!code highlight] */
@source '../node_modules/deck-openapi/dist/**/*.js';
```

### Configure Pages

Create an OpenAPI instance on the server. deck OpenAPI renders the pages on server-side.

```ts title="lib/source.ts"
import { createOpenAPI, attachFile } from 'deck-openapi/server';
