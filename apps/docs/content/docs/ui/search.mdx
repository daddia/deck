...
deck UI provides a good-looking search UI for your docs, the search functionality is instead provided and documented on deck Core.
...
import { RootProvider } from 'deck-ui/root-provider';
...
'use client';
import SearchDialog from 'deck-ui/components/dialog/search-default';
...
import {
  SearchDialog,
  type SharedProps,
} from 'deck-ui/components/dialog/search';
