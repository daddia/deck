---
title: Static Export
description: Enable static export with deck
---

## Overview

deck is fully compatible with Next.js static export, allowing you to export the app as a static HTML site without a Node.js server.
