---
title: Making a Blog with deck
description: deck + Blog
author: Fuma Nama
date: 2024-12-15
---

deck is a docs framework, but it's also a powerful tool to manage content in Next.js. You can use deck to build a blog site along with docs, on a single Next.js app.

## Overview

This guide helps you to build a blog site with deck and deck MDX.

We will use deck MDX to manage the content, and implement our own UI with Tailwind CSS & deck UI.
...
import { defineCollections, frontmatterSchema } from 'deck-mdx/config';
...
Colors like `text-fd-muted-foreground` are from the design system of deck UI, you may also use your own colors, or use Shadcn UI.
